...
try:
    ...
    from .historical_content.credentials import resolve_api_key
    from .historical_content.preview import seed_preview
...
def parser() -> argparse.ArgumentParser:
    ...
    create.add_argument("source_dir", type=Path, help="All-in-One exported version folder.")
