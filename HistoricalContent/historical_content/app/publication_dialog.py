...
from ..publishing.credentials import (
    CredentialStoreError, delete_credentials, is_supported as credential_saving_supported,
    load_credentials, save_credentials,
)
from ..publishing.core import (
    PublishPlan, PublisherError, PublisherSettings, R2Publisher, ValidationReport,
    format_bytes, validate_publisher_source,
)
from ..settings import (
    PUBLISHER_CONFIG_PATH as CONFIG_PATH,
    PUBLISHER_CREDENTIAL_PATH as CREDENTIAL_PATH,
    PUBLISHER_STATE_DIR as STATE_DIR,
    migrate_publisher_state,
)
from ..publishing.selection import local_publish_versions, bulk_publish_order
...
class PublicationDialog(tk.Toplevel):
    ...
    def _publish_multiple(self) -> None:
        try:
            ...
            return
        versions, local_latest = local_publish_versions(self.source_dir, self.game)
        if not versions:
        ...
        def action() -> None:
            ...
            publish_order = bulk_publish_order(
                selected,
                settings_by_id,
    ...
    def _manage_versions(self) -> None:
        try:
            ...
            return
        VersionManagerDialog(self, R2Publisher(settings, self._append_log), self._append_log)
